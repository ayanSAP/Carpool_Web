...
document.addEventListener("DOMContentLoaded", function () {
  ...
  searchButton.addEventListener("click", function (event) {
    ...
    window.localStorage.setItem("leaving-from", leavingFrom);
    window.localStorage.setItem("going-to", goingTo);
    window.localStorage.setItem("date-time", datetime);
    window.localStorage.setItem("passenger-count", passengerCount);

    //transferring the data to next page
    window.location.href = "../found-ride.html";
